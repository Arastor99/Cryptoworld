        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form method="POST" action="{{ route('login') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="text-right text-gray-400 hover:underline hover:text-gray-100 inline-block items-end px-20">
                        <a href="{{ route('password.request') }}">
                            {{ __('¿Has olvidado tu contraseña?') }}
                        </a>
                    </div>
                    <div class="text-right text-gray-400 hover:underline hover:text-gray-100 inline-block items-start px-20 ">
                        <a href="/login">
                            {{ __('¿No tienes cuenta?') }}
                        </a>
                    </div>
                    <div class="px-4 pb-2 pt-4">
                        <button class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">{{ __('Iniciar Sesión') }}</button>
                    </div>
